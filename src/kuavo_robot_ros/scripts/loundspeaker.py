#!/usr/bin/env python3
import rospy
from kuavo_robot_ros.srv import playmusic, playmusicResponse, playmusicRequest
import os
import subprocess  # 引入 subprocess 模块

# audio_path = os.environ['HOME'] + '/kuavo_ros_application/Music/hair_awe'
audio_path = os.environ['HOME'] + '/kuavo_ros_application/Music/hair_awe_man'
